...
export function loadTranslations(language) {
    return fetch(`translations/${language}.json`)
        ...
        .then(translations => {
            ...
            document.getElementById('miner-title').innerText = translations.miner.title;
            document.getElementById('miner-exp-label').innerText = translations.miner.expLabel;
            document.getElementById('miner-level-label').innerText = translations.miner.levelLabel;
            document.getElementById('miner-resources-label').innerText = translations.miner.resourcesLabel;
            document.getElementById('lumberjack-title').innerText = translations.lumberjack.title;
            document.getElementById('lumberjack-exp-label').innerText = translations.lumberjack.expLabel;
            document.getElementById('lumberjack-level-label').innerText = translations.lumberjack.levelLabel;
            document.getElementById('lumberjack-resources-label').innerText = translations.lumberjack.resourcesLabel;
